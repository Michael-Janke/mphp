...
def merge_gtex_tcga(name):
    ...
    TCGA_META_FILES = sorted(glob("data/"+name+"/subsets/TCGA*_meta_data.npy"))
    GTEX_META_FILES = sorted(glob("data/"+name+"/subsets/GTEX*_meta_data.npy"))
    TCGA_FILES = sorted(glob("data/"+name+"/subsets/TCGA*_count_data.npy"))
    GTEX_FILES = sorted(glob("data/"+name+"/subsets/GTEX*_count_data.npy"))
