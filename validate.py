...
app = falcon.API()
app.add_route('/validate/internal/{req}', InternalValidationResource(dataLoader))
app.add_route('/validate/external/{req}', ExternalValidationResource(dataLoader))
app.add_route('/validate/genes/{search}', GeneLookupResource(dataLoader))
